...
* @returns {Uint8Array}
*/
export function remove_update_tag(buffer: Uint8Array, modifications: string): Uint8Array;
/**
* @param {Uint8Array} buffer
* @param {(string)[]} tags
* @returns {string}
...
export interface InitOutput {
  ...
  readonly remove_update_tag: (a: number, b: number, c: number, d: number, e: number) => void;
